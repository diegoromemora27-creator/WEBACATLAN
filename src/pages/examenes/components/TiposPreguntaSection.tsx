...
const tipos = [
  ...
  },
  {
    ...
    border: '#145214',
    bg: '#F0FFF0',
    puntos: '0.5 puntos c/u',
    descripcion: 'Afirmaciones sobre conceptos del curso. Debes determinar si son verdaderas o falsas. Cuidado con las afirmaciones parcialmente correctas.',
    ejemplo: '"Docker y una máquina virtual son exactamente lo mismo porque ambos aíslan aplicaciones."\n→ FALSO ✓ (difieren en cómo virtualizan)',
    tips: ['Las afirmaciones absolutas (siempre, nunca) suelen ser falsas', 'Busca la "trampa" en el enunciado', 'Si hay duda, analiza cada parte'],
  },
  {
    nivel: 'NIVEL 3',
    ...
    bg: '#FFFBF0',
    puntos: '2 puntos c/u',
    descripcion: 'Se presenta un fragmento de código con espacios en blanco. Debes completar la sintaxis correcta. Evalúa conocimiento práctico.',
    ejemplo: '@_____()\nexport class UsersModule {\n  imports: [TypeOrmModule._____([\n    User\n  ])]\n}\n→ @Module() y forFeature()',
  ...
  },
  {
    ...
    descripcion: 'Dos columnas de conceptos que debes emparejar correctamente. Evalúa la comprensión de relaciones entre términos y definiciones.',
  ...
  },
  {
    ...
    bg: '#F0F4FF',
    puntos: '3 puntos c/u',
    descripcion: 'Preguntas abiertas que requieren una respuesta breve (2-5 líneas). Evalúa comprensión profunda y capacidad de explicar conceptos.',
    ejemplo: '¿Qué diferencia hay entre una imagen y un contenedor en Docker?\n→ La imagen es la plantilla inmutable; el contenedor es la instancia en ejecución de esa imagen.',
    tips: ['Sé preciso y conciso', 'Usa terminología técnica correcta', 'Incluye un ejemplo si el tiempo lo permite'],
  },
  {
    nivel: 'BOSS',
    ...
    bg: '#FFF8F0',
    puntos: '5 puntos c/u',
    descripcion: 'Se presenta un escenario real de desarrollo. Debes analizar, diseñar o resolver el problema aplicando los conceptos del curso.',
    ejemplo: 'Diseña la arquitectura de una app de delivery: identifica módulos, capas, tecnologías y justifica tus decisiones de diseño.',
    tips: ['Estructura tu respuesta con secciones', 'Justifica cada decisión técnica', 'Menciona trade-offs cuando aplique'],
  },
];
