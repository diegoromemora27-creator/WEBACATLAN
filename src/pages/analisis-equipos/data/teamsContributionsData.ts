...
export const equiposContribuciones: TeamContribuciones[] = [
  {
    ...
    integrantes: [
      { usuario: 'JazGil', rol: 'Collaborator', estado: 'Approved', contribuciones: 3 },
      { usuario: 'SinR0str0', rol: 'Collaborator', estado: 'Approved', contribuciones: 3 },
      { usuario: 'RamonMedina04', rol: 'Collaborator', estado: 'Approved', contribuciones: 3 },
      { usuario: 'ZairaP-coder', rol: 'Collaborator', estado: 'Approved', contribuciones: 2 },
  ...
  },
  {
    ...
    integrantes: [
      ...
      { usuario: 'sav1209', rol: 'Collaborator', estado: 'Approved', contribuciones: 3 },
  ...
  },
  {
    ...
    integrantes: [
      ...
      { usuario: 'EstefaniDL', rol: 'Contributor', estado: 'Approved', contribuciones: 5 },
  ...
  },
  {
    ...
    integrantes: [
      { usuario: 'BrunoAG2610', rol: 'Collaborator', estado: 'Approved', contribuciones: 7 },
      { usuario: 'FernandoMR10', rol: 'Collaborator', estado: 'Approved', contribuciones: 6 },
      { usuario: 'JosueTP09', rol: 'Collaborator', estado: 'Approved', contribuciones: 6 },
      { usuario: 'danielamh1302', rol: 'Collaborator', estado: 'Approved', contribuciones: 2 },
    ],
  },
  {
    equipo: 5,
    ...
    integrantes: [
      { usuario: 'aliiiiscf', rol: 'Collaborator', estado: 'Approved', contribuciones: 7 },
  ...
  },
  {
    ...
    integrantes: [
      { usuario: 'Dieg0Her13ra', rol: 'Collaborator', estado: 'Approved', contribuciones: 7 },
