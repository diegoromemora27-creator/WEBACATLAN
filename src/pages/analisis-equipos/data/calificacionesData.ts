...
export const estudiantesCalificaciones: EstudianteCalificacion[] = [
  ...
  { nombre: 'Hernández González Armando', equipoId: 7, tareasNoEntregadas: [], examen1: 73, examen2: 78, examen3: 100, calificacionExamenes: 73, primeraVuelta: false, motivoPrimeraVuelta: 'Examen 2 no aprobado' },
