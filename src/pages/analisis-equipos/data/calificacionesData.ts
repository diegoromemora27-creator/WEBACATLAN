...
export const estudiantesCalificaciones: EstudianteCalificacion[] = [
  ...
  { nombre: 'Elías García Luis David', equipoId: 6, tareasNoEntregadas: [], examen1: 100, examen2: 85, examen3: 100, calificacionExamenes: 95, primeraVuelta: false, motivoPrimeraVuelta: '' },
  ...
  { nombre: 'Rojas Uriostigue Rodrigo', equipoId: 10, tareasNoEntregadas: [], examen1: 83, examen2: 96, examen3: 100, calificacionExamenes: 93, primeraVuelta: false, motivoPrimeraVuelta: '' },
  ...
  { nombre: 'Escutia Pascacio Eduardo Emiliano', equipoId: 6, tareasNoEntregadas: [], examen1: 84, examen2: 84, examen3: 100, calificacionExamenes: 89, primeraVuelta: false, motivoPrimeraVuelta: '' },
