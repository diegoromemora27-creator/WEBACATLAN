...
const tipos = [
  ...
  },
  {
    ...
    color: '#00DDFF',
    border: '#0099BB',
    bg: 'rgba(0,221,255,0.05)',
    puntos: '0.5 puntos c/u',
    descripcion: 'Afirmaciones sobre HTML, CSS, TypeScript o POO. Determina si son verdaderas o falsas. Cuidado con las afirmaciones parcialmente correctas.',
    ejemplo: '"En TypeScript, una interface y un type son exactamente lo mismo en todos los casos."\n→ FALSO ✓ (hay diferencias en extensión y declaración)',
    tips: ['Las afirmaciones absolutas suelen ser falsas', 'Busca la "trampa" en el enunciado', 'Analiza cada parte por separado'],
  },
  {
    nivel: 'WAVE 3',
  ...
  },
  {
    ...
    puntos: '3 puntos c/u',
    descripcion: 'Preguntas abiertas (2-5 líneas). Explica conceptos de Frontend, TypeScript o POO con terminología técnica correcta.',
    ejemplo: '¿Qué diferencia hay entre SSR y SSG en Next.js?\n→ SSR genera el HTML en cada petición; SSG lo genera en build time. SSR es dinámico, SSG es estático y más rápido.',
  ...
  },
  {
    ...
    puntos: '5 puntos c/u',
    descripcion: 'Escenario real de desarrollo Frontend o Backend. Analiza, diseña o resuelve aplicando los conceptos del curso.',
    ejemplo: 'Diseña la estructura de componentes de una app de e-commerce en Next.js: identifica páginas, componentes reutilizables y estrategia de renderizado.',
