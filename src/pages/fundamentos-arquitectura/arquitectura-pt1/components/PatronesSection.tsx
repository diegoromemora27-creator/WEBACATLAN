...
class UsuarioController {
  obtenerUsuario(id: number) {
    return usuarioRepository.findById(id);
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 md:p-10 border border-blue-100">
          <div className="flex items-start gap-4 mb-6">
            <div className="w-12 h-12 md:w-14 md:h-14 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-xl flex items-center justify-center flex-shrink-0">
              <i className="ri-shape-line text-white text-xl md:text-2xl"></i>
            </div>
            <div className="flex-1">
              <h3 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
              ...
              <p className="text-base md:text-lg text-gray-700 leading-relaxed mb-4">
                <strong>Idea clave:</strong> el núcleo de negocio (dominio) está en el centro y no depende de detalles externos (framework, base de datos, HTTP, etc.).
              </p>
            </div>
          </div>

          {/* Ejemplo Uber */}
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-xl p-6 md:p-8 mb-6">
            <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <i className="ri-taxi-line text-blue-600"></i>
              Ejemplo: Core de Uber
            </h4>
            <p className="text-base md:text-lg text-gray-700 mb-6 leading-relaxed">
              Imagina el "core" de Uber: reglas para calcular tarifas, asignar conductor, estados del viaje. Eso debería funcionar igual sin importar si el cliente está en app iOS, Android o web.
            </p>
              ...
              <div className="bg-white rounded-xl p-5 md:p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-blue-100 rounded-lg flex items-center justify-center">
                    <i className="ri-plug-line text-blue-600 text-xl"></i>
                  </div>
                  <h5 className="text-lg md:text-xl font-bold text-gray-900">Puertos</h5>
                </div>
                <p className="text-sm md:text-base text-gray-600 mb-4">
                  Interfaces que definen cómo el mundo externo habla con el core
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm md:text-base text-gray-700">
                    ...
                    <span>ServicioDePagos</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm md:text-base text-gray-700">
                    <i className="ri-checkbox-circle-fill text-blue-500"></i>
                    <span>RepositorioDeUsuarios</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm md:text-base text-gray-700">
                    <i className="ri-checkbox-circle-fill text-blue-500"></i>
                    <span>ServicioDeNotificaciones</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-5 md:p-6 shadow-sm">
                <div className="flex items-center gap-3 mb-4">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-indigo-100 rounded-lg flex items-center justify-center">
                    <i className="ri-outlet-2-line text-indigo-600 text-xl"></i>
                  </div>
                  <h5 className="text-lg md:text-xl font-bold text-gray-900">Adaptadores</h5>
                </div>
                <p className="text-sm md:text-base text-gray-600 mb-4">
                  Implementaciones concretas que se conectan a los puertos
                </p>
                <div className="space-y-2">
                  <div className="flex items-center gap-2 text-sm md:text-base text-gray-700">
                    <i className="ri-arrow-right-circle-fill text-indigo-500"></i>
                    <span>Adaptador HTTP REST (app móvil)</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm md:text-base text-gray-700">
                    <i className="ri-arrow-right-circle-fill text-indigo-500"></i>
                    <span>Adaptador GraphQL (web)</span>
                  </div>
                  <div className="flex items-center gap-2 text-sm md:text-base text-gray-700">
                    <i className="ri-arrow-right-circle-fill text-indigo-500"></i>
                    <span>Adaptador Stripe/PayPal (pagos)</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          {/* Ventaja clave */}
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 md:p-8 mb-6">
            <h4 className="text-lg md:text-xl font-bold text-gray-900 mb-4 flex items-center gap-2">
              <i className="ri-lightbulb-flash-line text-green-600"></i>
              Ventaja clave: Flexibilidad sin tocar el core
            </h4>
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm md:text-base text-gray-700">
                  <strong>Hoy:</strong> Tu app solo expone REST
                </p>
              </div>
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm md:text-base text-gray-700">
                  <strong>Mañana:</strong> Marketing pide GraphQL o gRPC
                </p>
              </div>
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm md:text-base text-gray-700">
                  <strong>Solución:</strong> Agregas otro adaptador sin tocar la lógica de negocio, solo enchufas otro "cable" al mismo puerto
                </p>
              </div>
            </div>
          </div>
          ...
          {/* Botón ejemplo interactivo */}
          <button
            onClick={() => setShowHexagonalExample(!showHexagonalExample)}
            className="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 md:py-4 rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 flex items-center justify-center gap-2 whitespace-nowrap"
          >
            <i className={`ri-${showHexagonalExample ? 'eye-off' : 'eye'}-line`}></i>
            {showHexagonalExample ? 'Ocultar' : 'Ver'} ejemplo de código hexagonal
          </button>

          {showHexagonalExample && (
            <div className="bg-gray-900 rounded-xl p-4 md:p-6 overflow-x-auto mt-6">
              <pre className="text-xs md:text-sm text-green-400">
{`// PUERTO (Interfaz)
interface ServicioDePagos {
  procesarPago(monto: number, metodo: string): Promise<boolean>;
}

// CORE DE NEGOCIO (independiente de detalles)
class ProcesadorDeViajes {
  constructor(private pagos: ServicioDePagos) {}
  
  async completarViaje(viajeId: string, tarifa: number) {
    const exitoso = await this.pagos.procesarPago(tarifa, 'tarjeta');
    if (exitoso) {
      // lógica de negocio...
    }
  }
...
// ADAPTADOR 1: Stripe
class AdaptadorStripe implements ServicioDePagos {
  async procesarPago(monto: number, metodo: string) {
    return await stripe.charges.create({ amount: monto });
  }
}

// ADAPTADOR 2: PayPal (nuevo, sin tocar el core)
class AdaptadorPayPal implements ServicioDePagos {
  async procesarPago(monto: number, metodo: string) {
    return await paypal.payment.create({ amount: monto });
  }
}`}
              </pre>
            </div>
        ...
        {/* Comparación visual */}
        <div className="mt-8 md:mt-12 bg-gradient-to-r from-purple-100 via-blue-100 to-indigo-100 rounded-2xl p-6 md:p-10">
            ...
            <div className="bg-white rounded-xl p-5 md:p-6 shadow-md">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 bg-purple-500 rounded-lg flex items-center justify-center">
                  <i className="ri-stack-fill text-white"></i>
                </div>
                <h4 className="text-lg md:text-xl font-bold text-gray-900">Capas</h4>
              </div>
              <ul className="space-y-2 text-sm md:text-base text-gray-700">
                <li className="flex items-start gap-2">
                  <i className="ri-check-line text-green-600 mt-1"></i>
                  <span>Organización vertical clara</span>
                </li>
                <li className="flex items-start gap-2">
                  <i className="ri-check-line text-green-600 mt-1"></i>
                  <span>Fácil de entender y enseñar</span>
                </li>
                <li className="flex items-start gap-2">
                  <i className="ri-check-line text-green-600 mt-1"></i>
                  <span>Ideal para apps tradicionales</span>
                </li>
                <li className="flex items-start gap-2">
                  <i className="ri-alert-line text-orange-600 mt-1"></i>
                  <span>Puede crear dependencias rígidas</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white rounded-xl p-5 md:p-6 shadow-md">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center">
                  <i className="ri-shape-line text-white"></i>
                </div>
                <h4 className="text-lg md:text-xl font-bold text-gray-900">Hexagonal</h4>
              </div>
              <ul className="space-y-2 text-sm md:text-base text-gray-700">
                <li className="flex items-start gap-2">
                  <i className="ri-check-line text-green-600 mt-1"></i>
                  <span>Core de negocio independiente</span>
                </li>
                <li className="flex items-start gap-2">
                  <i className="ri-check-line text-green-600 mt-1"></i>
                  <span>Fácil cambiar tecnologías</span>
                </li>
                <li className="flex items-start gap-2">
                  <i className="ri-check-line text-green-600 mt-1"></i>
                  <span>Ideal para sistemas complejos</span>
                </li>
                <li className="flex items-start gap-2">
                  <i className="ri-alert-line text-orange-600 mt-1"></i>
                  <span>Requiere más planificación inicial</span>
                </li>
              </ul>
            </div>
          </div>
